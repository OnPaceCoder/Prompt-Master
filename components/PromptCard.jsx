    ...
    return (
        <div className="prompt_card">
            ...
            {session?.user.id === post.creator._id && pathName === '/profile' && (
                <div className='mt-5 flex-center gap-5 border-t border-gary-100 pt-3'>
                    <p className='font-inter text-sm green_gradient cursor-pointer' onClick={() => handleEdit(post)}>
                        Edit
                    </p>
                    <p className='font-inter text-sm gradient_gradient cursor-pointer' onClick={handleDelete}>
                        Delete
                    </p>
                </div>
            )}
